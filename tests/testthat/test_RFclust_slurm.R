...
rfCluster_row( x, subset=79, rep=1, slice=1,k=3, nforest=5, ntree=5, settings = list( 'A' = "lsens2017-3-2", t="00:20:00" ,p="dell" ) )
rfCluster_col( x, subset=10, rep=1, slice=1,k=3, nforest=5, ntree=5, settings = list( 'A' = "lsens2017-3-2", t="00:20:00" ,p="dell" ) )
