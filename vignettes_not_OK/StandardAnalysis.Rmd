...
e.g. use DEseq2 for statistical analysis; a SingleCells object is meant to store SingleCell NGS data statistics for this type of data is not implemented any more; and finally Microarray is an old implemtaion using limma for the startistics.
